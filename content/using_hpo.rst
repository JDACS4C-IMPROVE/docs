...
We have two workflows for HPO: `Supervisor HPO <using_hpo_supervisor>` (based on Genetic Algorithms) and `DeepHyper HPO <using_hpo_deephyper>` (based on Bayesian Optimization).
...
References
------------
`1. <https://ieeexplore.ieee.org/document/8638041>`_ P. Balaprakash et al. "DeepHyper: Asynchronous Hyperparameter Search for Deep Neural Networks", IEEE, 2018 <br>
